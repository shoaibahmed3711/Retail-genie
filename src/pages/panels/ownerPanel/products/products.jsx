...
import { Plus, Package, Search, Filter, SortAsc, Share2, Heart, Edit2, Trash2, TrendingUp, ShoppingCart, Clock, DollarSign, Box, Briefcase, Award } from 'lucide-react';
        ...
        <div className="bg-white hover:bg-gray-100 transition-colors duration-200 rounded-2xl p-6 shadow-lg hover:shadow-xl">
            ...
            <div className="mb-4">
                <button
                    ...
                    className="text-sm bg-green-50 text-green-600 px-3 py-1.5 rounded-lg hover:bg-green-100 transition-colors"
                >
                    Record Sale
                </button>
                ...
                {showSaleForm && (
                    <div className="mt-3 p-3 border border-gray-200 rounded-lg bg-gray-50">
                        <h4 className="font-medium text-sm mb-2">Record New Sale</h4>
                        <form onSubmit={handleRecordSale} className="space-y-3">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="bg-gray-200 text-gray-600 px-3 py-1.5 rounded-lg text-sm hover:bg-gray-300"
                                >
                                    Cancel
                                </button>
                            </div>
