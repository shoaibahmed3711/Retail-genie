    ...
    <AuthLayout title="Join Us" description="Create an account to start exploring our platform and all its features." >
      <div className="">
        <div className="w-full max-w-md space-y-8">
          {error && (
            <div className="rounded-md bg-white border-[1px] border-red-300 p-4">
              <div className="flex">
                <div className="ml-3">
            ...
            <div className="space-y-4 rounded-md shadow-sm">
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block text-white w-full rounded-md border ${errors.name ? 'border-red-300' : 'border-gray-300'
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`mt-1 block text-white w-full rounded-md border ${errors.email ? 'border-red-300' : 'border-gray-300'
                    } px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm`}
                />
                {errors.email && (
              ...
              <div>
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="mt-1 block text-white w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                >
                  {roles.map((role) => (
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`mt-1 block text-white w-full rounded-md border ${errors.password ? 'border-red-300' : 'border-gray-300'
                    } px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm`}
                />
                <button
                  type="button"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`mt-1 block text-white w-full rounded-md border ${errors.confirmPassword ? 'border-red-300' : 'border-gray-300'
                    } px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm`}
                />
