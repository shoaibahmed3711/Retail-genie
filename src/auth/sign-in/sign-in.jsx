  ...
  return (
    <div className="flex h-screen w-full bg-gray-900">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="mb-8 flex items-center">
            <Link to='/' className="text-indigo-500 font-bold text-2xl flex items-center">
          ...
          <div className="bg-gray-800 rounded-lg p-8">
            ...
            <form>
              <div className="mb-4 relative">
                ...
                <input
                  type="text"
                  className="bg-gray-700 text-white text-sm rounded-lg pl-10 w-full p-2.5 focus:ring-indigo-500 focus:border-indigo-500"
              ...
              <button
                type="submit"
                className="w-full text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 focus:ring-4 focus:ring-purple-500/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-4"
              >
      ...
      <div className="hidden md:flex md:w-1/2 bg-gray-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-800/40 to-indigo-900/40"></div>
        ...
        <div className="absolute w-full h-full">
          <svg viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="absolute inset-0 w-full h-full opacity-50">
            <path d="M0,800 C200,700 400,900 600,800 C800,700 1000,800 1000,700 V1000 H0 V800 Z" fill="url(#purpleGradient)" className="animate-pulse">
